...
class SiteController extends Controller
{
    ...
    public function contactSubmit(Request $request)
    {
        ...
        return to_route('ticket.view', ['ticket' => $ticket->ticket])->withNotify($notify);
    }
    ...
    public function blogDetails($id, $slug)
    {
        ...
        $recentBlog = Frontend::where('data_keys','blog.element')->where('id','!=',$id)->take(6)->get();
        ...
        $seoContents['image']              = getImage('assets/images/frontend/blog/' . @$blog->data_values->image, '860x420');
        $seoContents['image_size']         = '860x420';
        return view($this->activeTemplate . 'blog_details', compact('blog', 'pageTitle','recentBlog','seoContents'));
    }
