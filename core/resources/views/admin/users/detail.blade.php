        ...
        <div class="col-12">
            ...
            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{route('admin.trade.log.index')}}?user_id={{ $user->id }}"
                        icon="las la-gamepad"
                        title="Total Trades"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{route('admin.trade.log.wining')}}?user_id={{ $user->id }}"
                        icon="las la-trophy"
                        title="Win Trades"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{ route('admin.trade.log.losing') }}?user_id={{ $user->id }}"
                        icon="las la-slash"
                        title="Loss Trades"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="3"
                        link="{{ route('admin.trade.log.draw') }}?user_id={{ $user->id }}"
