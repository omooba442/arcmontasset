    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($widget['total_withdrawals']) }}
                            </h3>
            ...
            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.trade.log.index') }}?user_id={{ $user->id }}"
                        icon="las la-gamepad" title="Total Trades" value="{{ getAmount($widget['total_trade']) }}"
                        bg="15" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.trade.log.wining') }}?user_id={{ $user->id }}"
                        icon="las la-trophy" title="Win Trades" value="{{ getAmount($widget['total_wining_trade']) }}"
                        bg="success-2" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.trade.log.losing') }}?user_id={{ $user->id }}"
                        icon="las la-slash" title="Loss Trades" value="{{ getAmount($widget['total_losing_trade']) }}"
                        bg="danger-2" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.trade.log.draw') }}?user_id={{ $user->id }}"
                        icon="las la-draw-polygon" title="Draw Trades" value="{{ getAmount($widget['total_draw_trade']) }}"
                        bg="3" />
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="wallet" required>
                                ...
                                <option value="ETH">@lang('ETH')</option>
                            </select>
                        </div>
                        <div class="form-group">
